...
async def main(connection):
    ...
    if window is not None:
        await launch_system(window, "~/code/core-services", "serverweb")
        await launch_system(window, "~/code/core-services", "serverworkers")
        await launch_system(window, "~/code/core-services", "travelweb")
        await launch_system(window, "~/code/core-services", "travelworkers")
        ...
        await launch_system(window, "~/code/python-services", "accounting")
